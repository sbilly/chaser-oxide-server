...
from chaser.oxide.v1 import event_pb2 as event__pb2
...
class EventServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Subscribe = channel.stream_stream(
                '/chaser.oxide.v1.EventService/Subscribe',
...
def add_EventServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'chaser.oxide.v1.EventService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('chaser.oxide.v1.EventService', rpc_method_handlers)
